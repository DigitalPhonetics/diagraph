...
def load_weather_domain():
    from apps.webapi.weather import WeatherNLU, WeatherNLG, WeatherDomain
...
def load_qa_domain():
    from apps.qa.worldknowledge.semanticparser import QuestionParser
    from apps.qa.worldknowledge.domain import WorldKnowledgeDomain
    from apps.qa.worldknowledge.policyqa import QaPolicy
    from apps.qa.worldknowledge.multinlg import MultiNLG
    from services.service import DialogSystem
    from utils.domain.jsonlookupdomain import JSONLookupDomain
    from utils.logger import DiasysLogger, LogLevel
