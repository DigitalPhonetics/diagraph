...
from .views.graphs import graph_list, delelete_graph, rename_graph, edit_graph, create_graph, load_graph, dialog_logs, change_settings
from .views.survey import survey_view, log_survey_results
from .views.upload_media import upload_image
...
urlpatterns = [
    ...
    path("data/change_settings/<str:graphId>", change_settings, name='change_settings'),
